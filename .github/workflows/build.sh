...
rm -r "${GITHUB_WORKSPACE}/services/node_modules/@g42cloud/g42cloud-sdk-core"
mkdir -p "${GITHUB_WORKSPACE}/services/node_modules/@g42cloud"
cp -r "${GITHUB_WORKSPACE}/build/core" "${GITHUB_WORKSPACE}/services/node_modules/@g42cloud/g42cloud-sdk-core"
